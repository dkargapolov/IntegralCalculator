...
match type:
    ...
    case 2:
        ...
        a = int(input('Введите внешний нижний предел: '))
        b = int(input('Введите внешний верхний предел: '))
        c = int(input('Введите внутренний нижний предел: '))
        d = int(input('Введите внутренний верхний предел: '))
        nx = int(input('Введите количество разбиений для внешнего предела: '))
        ny = int(input('Введите количество разбиений для внутреннего предела: '))

        print('\nКакой метод кратного численного интегрирования вы выберите: '
              '\n 1. Метод прямоугольников левых частей '
              '\n 2. Метод прямоугольников правых частей '
              '\n 3. Метод трапеций '
              '\n 4. Метод парабол')
        ...
        match method:
            case 1:
                print('\nВы выбрали метод прямоугольников левых частей')
                print(f'\nРезультат: {mLeft(a, b, c, d, nx, ny)}')
            case 2:
                print('\nВы выбрали метод прямоугольников правых частей')
                print(f'\nРезультат: {mRight(a, b, c, d, nx, ny)}')
            case 3:
                print('\nВы выбрали метод трапеций')
                print(f'\nРезультат: {mTrap(a, b, c, d, nx, ny)}')
            case 4:
                print('\nВы выбрали метод парабол')
                print(f'\nРезультат: {mSimp(a, b, c, d, nx, ny)}')